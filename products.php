                                ...
                                <div class="product-card" onclick="window.location.href='product.php?id=<?= $product['id'] ?>'">
                                    ...
                                    <div class="product-image-wrapper">
                                        ...
                                        <div class="product-actions">
                                            ...
                                            <?php endif; ?>
                                            <button class="product-action-btn" onclick="event.stopPropagation(); addToCart(<?= $product['id'] ?>)"><svg class="icon-svg-inline" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg></button>
                                        </div>
                                    </div>
